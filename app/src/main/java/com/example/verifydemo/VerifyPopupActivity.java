...
public class VerifyPopupActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * */
        ...
        Log.e("Test","宽度：iframeWidthPX："+iframeWidthPX+" iframeWidthDP:"+iframeWidthDP);
        if (iframeWidthDP >= (int)(F_DEFAULT_POPUP_IFRAME_WIDTH*F_MAX_IFRAME_WIDTH_SCALE)){
            ...
            Log.e("Test","宽度超出极限值更新：iframeWidthPX："+iframeWidthPX+" iframeWidthDP:"+iframeWidthDP);
        }
        ...
        Log.e("Test","高度：iframeHeightPX："+iframeHeightPX+" iframeHeightDP:"+iframeHeightDP);
